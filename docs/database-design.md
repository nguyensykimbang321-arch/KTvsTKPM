...
Danh mục các dịch vụ được cung cấp.
...
| startTime | TIME | NOT NULL | Giờ bắt đầu |
| endTime | TIME | NOT NULL | Giờ kết thúc |
| status | ENUM('pending','confirmed','completed','cancelled') | DEFAULT 'pending' | Trạng thái |
